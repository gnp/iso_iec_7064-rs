...
mod tests {
    ...
    fn validate_examples_from_standard() {
        assert_eq!(true, MOD_11_2.validate_string("07940"));
        assert_eq!(false, MOD_11_2.validate_string("0794X"));

        assert_eq!(true, MOD_11_2.validate_string("079X"));
        assert_eq!(false, MOD_11_2.validate_string("0790"));
    }

    #[test]
    fn validate_rejects_supplementary_chars_in_payload() {
        assert_eq!(false, MOD_11_2.validate_string("X7940"));
    }
